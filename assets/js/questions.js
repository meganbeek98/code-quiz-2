var questions = [
    {
        title: "What is something JavaScript is used for?",
        choices: [
    ...
    {
        title: "Which is NOT one of the 7 main data types in JavaScript?",
        choices: [
            "summary",
            "strings",
            "numbers",
    ...
    {
        title: "Which JavaScript data type includes true/false statements?",
        choices: [
            "array",
            "number",
            "undefined",
    ...
    {
        title: "Who created the first ever JavaScript?",
        choices: [
            "Larry Page",
            "Brendon Eich",
            "Mark Zuckerberg",
